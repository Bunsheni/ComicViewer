...
namespace ComicViewer.CtModels
{
    public class CtGroup : CtModel
    {
        ...
        [Ignore]
        public override CtModelType CtType { get { return CtModelType.GROUP; } }
        [Ignore]
        ...
        public CtGroup(string name)
        {
            NameKr = NameEn = name;
            Synonym = string.Empty;
        }
        public CtGroup(string nameen, string namekr)
        {
            NameEn = nameen;
            NameKr = namekr;
            Synonym = string.Empty;
